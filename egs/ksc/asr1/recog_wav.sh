...
# rnnlm related
use_lang_model=true
lang_model=../nospeed_125_balanced_dev_broadcast/exp/train_rnnlm_pytorch_lm/rnnlm.model.best #if use_lang_model=true, path to rnnlm.model.best

# decoding parameter
cmvn=../nospeed_125_balanced_dev_broadcast/data/train/cmvn.ark #path to cmvn.ark for example data/train/cmvn.ark
recog_model=../nospeed_125_balanced_dev_broadcast/exp/train_pytorch_train_transformer_specaug/results/model.last10.avg.best  #path to model.last10.avg.best 
